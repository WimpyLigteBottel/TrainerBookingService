...
public class TrainerDetails {
    ...
    @Autowired
    private TrainerDetailManager trainerDetailManager;
    ...
    public ResponseEntity<?> createDetailedProfile(@PathVariable long id, @RequestBody TrainerDetailModel detailTrainerModel) {
